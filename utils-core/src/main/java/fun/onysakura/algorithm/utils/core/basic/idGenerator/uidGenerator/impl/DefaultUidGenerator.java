 ...
 */
package fun.onysakura.algorithm.utils.core.basic.idGenerator.uidGenerator.impl;

import fun.onysakura.algorithm.utils.core.basic.idGenerator.uidGenerator.BitsAllocator;
...
public class DefaultUidGenerator implements UidGenerator {
    ...
    protected int workerBits = 12;
    protected int seqBits = 19;
    /**
     * 开始时间
     */
    protected long epochSeconds = TimeUnit.MILLISECONDS.toSeconds(1600000000000L);
