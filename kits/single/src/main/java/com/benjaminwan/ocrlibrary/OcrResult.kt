...
data class OcrResult(val dbNetTime: Double, val textBlocks: ArrayList<TextBlock>, var detectTime: Double, var strRes: String) : OcrOutput()

data class Point(var x: Int, var y: Int)

data class TextBlock(val boxPoint: ArrayList<Point>, var boxScore: Float, val angleIndex: Int, val angleScore: Float, val angleTime: Double, val text: String, val charScores: FloatArray, val crnnTime: Double, val blockTime: Double) {
