package fun.onysakura.algorithm.kits.single.file.image.ocr;
...
public class OCRUtils {
    private final static String RESOURCES_PATH = "C:/Files/Workspace/Mine/Java/Algorithm/kits/single/src/main/resources/ocr";
    private final static String MODELS_PATH = RESOURCES_PATH + "/models/";
    private final static String DLL_PATH = RESOURCES_PATH + "/lib/OcrLiteNcnn.dll";
    ...
    private static void init() {
        ...
        ENGINE.setGpuIndex(-1); // GPU0 一般为默认 GPU，参数选项：使用 CPU(-1) / 使用GPU0(0) / 使用GPU1(1) / ...
