package fun.onysakura.algorithm.spring.security;

import fun.onysakura.algorithm.spring.common.result.Result;
import fun.onysakura.algorithm.spring.security.model.JwtAuthenticationRequest;
import fun.onysakura.algorithm.spring.security.service.AuthService;
